    ...
    .each(function() {
      ...
      module      = {
        ...
        validate: {
          ...
          field: function(field, fieldName, showErrors) {
            ...
            if($field.prop('disabled')) {
              ...
              $.each(field.rules, function(index, rule) {
                if( module.has.field(identifier) && !( module.validate.rule(field, rule, fieldErrors) ) ) {
          ...
          rule: function(field, rule, errors) {
            var
              $field       = module.get.field(field.identifier),
              type         = rule.type,
              value        = $field.val(),
            ...
            value = (value === undefined || value === '' || value === null)
              ...
              : $.trim(value + '')
            ;
            return ruleFunction.call($field, value, ancillary, errors);
          }
        },
